...
# Функция для запроса данных по государственным и муниципальным контрактам 
...
response_list_firm <- function() {
  sweet_firms <- c(
      "Холдинг КДВ Групп", "Мон'дэлис Русь", "Объединённые Кондитеры", "Булочно-кондитерский комбинат Коломенский",
      "Рот Фронт", "Ладога", "Акконд", "Невский Кондитер", "Пензенская кондитерская фабрика", "Конфил",
      "Шоколенд", "Конти-Рус", "Бабаевский", "Приморский кондитер", "Эссен Продакшн АГ", "Красный Октябрь",
      "Ферреро Руссия", "Кондитерская фабрика 'Нева'", "Кондитерская фабрика 'Ударница'", "Победа",
      "Ферреро Россия", "Кундрат", "Кубань Сласть", "Славица", "Шоколадная фабрика Новосибирская",
      "Сормовская кондитерская фабрика", "Пермская кондитерская фабрика", "Кондитерская фабрика Волжанка",
      "КОНДИТЕРСКАЯ ФАБРИКА ИМ. Н.К. КРУПСКОЙ", "КДВ Групп")
...
# Сохранение каждого элемента списка в отдельный CSV файл
for(i in seq_along(metrics_list)){
  write.csv(metrics_list[[i]], file = paste0("metrics_", i, ".csv"))
}
